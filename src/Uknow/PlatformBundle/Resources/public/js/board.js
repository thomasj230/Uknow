...
function domaineChoix(id, traduction){
    $('#domaine').val(id).html(traduction + '<span class="glyphicon glyphicon-triangle-left"></span>');
    $('#domaine-list').slideUp(300);
}
...
function matiereChoix(id, traduction){
    $('#matiere').val(id).html(traduction + '<span class="glyphicon glyphicon-triangle-left"></span>');
    $('#matiere-list').slideUp(300);
}
function themeList(){
...
function themeChoix(id, traduction){
    $('#theme').val(id).html(traduction + '<span class="glyphicon glyphicon-triangle-left"></span>');
    $('#theme-list').slideUp(300);
}
...
function chapitreChoix(id, traduction){
    $('#chapitre').val(id).html(traduction + '<span class="glyphicon glyphicon-triangle-left"></span>');
    $('#chapitre-list').slideUp(300);
}
...
function typeChoix(id, traduction){
    $('#type').val(id).html(traduction + '<span class="glyphicon glyphicon-triangle-left"></span>');
    $('#type-list').slideUp(300);
}
...
function niveauChoix(id, traduction){
    $('#niveau').val(id).html(traduction + '<span class="glyphicon glyphicon-triangle-left"></span>');
    $('#niveau-list').slideUp(300);
}